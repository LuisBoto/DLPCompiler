...
public class VarDef extends AbstractBloque {
    ...
    public boolean isLocalInFunc() {
    	return this.localInFunc;
    }
    
    public void setLocalInFunc(boolean local) {
    	this.localInFunc = local;
    }
    ...
    public void setParameter(Parametro p) {
    	this.parametro = p;
    }
    
    private int address;
    private boolean localInFunc = false;
